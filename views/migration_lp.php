            ...
            <div class="tutor-migration-top tutor-px-48 tutor-pt-32 tutor-pb-40">
                <div class="">
                    ...
                    <div class="tutor-migration-top-subtitle tutor-fs-6">
                        <?php _e('Seamlessly migrate your Learnpress courses to Tutor LMS with the Tutor LMS Migration Tool.','tutor-lms-migration-tool'); ?>
                    </div>
                </div>
			...
			<div class="migration-modal-btn-group migration-modal-consent-group flex-center tutor-flex-column">
				<div class="migration-modal-title tutor-fs-5 tutor-fw-medium tutor-color-black">
					...
					printf(
						...
						esc_html__( 'LearnPress', 'tutor-lms-migration-tool' )
					);
					?>
				</div>
				<?php
