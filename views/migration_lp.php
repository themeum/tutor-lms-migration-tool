			...
			<div class="lp-grid lp">
				<div class="lp-migratoin-left">
					<div class="lp-migration-heading">
						...
						echo sprintf(
							__(
								'Transfer everything from your LearnPress database to %s Tutor LMS hasslefree with just one-click.',
...
-->
						...
						<div class="lp-required-migrate-stats">
							<p id="lp_required_migrate_stats">
								<?php echo sprintf( __( '%1$s courses, %2$s sales data, %3$s reviews will be migrated', 'tutor-lms-migration-tool' ), $courses_count, $orders_count, $reviews_count ); ?>
							</p>
						</div>
					</form>
				</div>
