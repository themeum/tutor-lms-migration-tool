...
<div class="lp-success-modal-wrap">
	<div class="lp-success-modal <?php if ( isset( $_SESSION["tutor-migration-success"] ) ) { echo ' active';  } ?>" >
		<div class="lp-modal-alert tutor-p-40">
			...
			<div class="tutor-fs-6 tutor-fw-mediumd tutor-color-black tutor-mt-12"> <?php _e( 'The migration from LearnDash to Tutor LMS is successfully done.', 'tutor-lms-migration-tool' ); ?> </div>
